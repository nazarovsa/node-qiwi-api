...
module.exports = function Qiwi(token) {
     ...
     * @param {function(err,data)} callback 
     */
    this.getAccountLimits = function (wallet, requestOptions, callback) {
    ...
    * @param {function(err,data)} callback 
    */
    this.toRequisites = function (requestOptions, callback) {
        var options = {
     ...
     * @param {{amount:number, currency:string, account:string, comment:string}} requestOptions
     * account - number of your wallet, example: '+79991234567'
     * @param {function(err,data)} callback 
     */
    this.convertCurrency = function (requestOptions, callback) {
        var options = {
     ...
     * @param {function(err,data)} callback 
     */
    this.getNewWebHookSecret = function (hookId, callback) {
        var options = {
     ...
     * @param {function(err,data)} callback 
     */
    this.getInvoices = function (requestOptions, callback) {
        var options = {
     ...
     * @param {function(err,data)} callback 
     */
    this.payInvoice = function (invoiceId, currency, callback) {
        var options = {
     ...
     * @param {function(err,data)} callback 
     */
    this.cancelInvoice = function (invoiceId, callback) {
        var options = {
